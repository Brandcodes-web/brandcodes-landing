          ...
          >
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc pl-6 text-cool-600 space-y-2">
                <li>Visit our website at <a href="https://brandcodes.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:text-brand-700">https://brandcodes.vercel.app/</a> or any website of ours that links to this Privacy Notice</li>
              ...
              <p className="text-lg text-cool-600 mt-4">
                <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:77jack0105@gmail.com" className="text-brand-500 hover:text-brand-700">77jack0105@gmail.com</a>.
              </p>
            </div>
            ...
            <div className="bg-brand-50 rounded-xl p-8 mb-12">
              ...
              <div className="space-y-4 text-cool-700">
                ...
                <div>
                  <strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a <a href="https://app.termly.io/dsar/2f9e40ab-5415-459e-a363-4ff98f41b905" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:text-brand-700">data subject access request</a>, or by contacting us.
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <ol className="list-decimal pl-6 text-brand-500 space-y-2">
                ...
                <li><a href="#legalbases" className="hover:text-brand-700">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a></li>
                ...
                <li><a href="#uslaws" className="hover:text-brand-700">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
            ...
            <div id="legalbases" className="mb-12">
              <h2 className="text-3xl font-bold text-navy-900 mb-6">3. What Legal Bases Do We Rely On To Process Your Personal Information?</h2>
              <p className="text-cool-600 mb-4">
            ...
            <div id="whoshare" className="mb-12">
              <h2 className="text-3xl font-bold text-navy-900 mb-6">4. When And With Whom Do We Share Your Personal Information?</h2>
              <p className="text-cool-600 mb-4">
            ...
            <div id="uslaws" className="mb-12">
              <h2 className="text-3xl font-bold text-navy-900 mb-6">11. Do United States Residents Have Specific Privacy Rights?</h2>
              <p className="text-cool-600 mb-4">
            ...
            <div id="policyupdates" className="mb-12">
              <h2 className="text-3xl font-bold text-navy-900 mb-6">12. Do We Make Updates To This Notice?</h2>
              <p className="text-cool-600 mb-4">
            ...
            <div id="contact" className="mb-12">
              <h2 className="text-3xl font-bold text-navy-900 mb-6">13. How Can You Contact Us About This Notice?</h2>
              <p className="text-cool-600 mb-4">
                If you have questions or comments about this notice, you may email us at <a href="mailto:77jack0105@gmail.com" className="text-brand-500 hover:text-brand-700">77jack0105@gmail.com</a>.
              </p>
            </div>

            {/* Section 14 */}
            <div id="request" className="mb-12">
              <h2 className="text-3xl font-bold text-navy-900 mb-6">14. How Can You Review, Update, Or Delete The Data We Collect From You?</h2>
              <p className="text-cool-600 mb-4">
                Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please submit a request by visiting <a href="https://app.termly.io/dsar/2f9e40ab-5415-459e-a363-4ff98f41b905" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:text-brand-700">our data request form</a>.
              </p>
            </div>
          </motion.div>
        </div>
